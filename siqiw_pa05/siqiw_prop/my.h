/*
  This is a header file for 'project.cpp'. This file defines a class for image. The class includes basic information and manipulation of image. 
...
//destructor
    ...
    {
       delete originaldata;
       std::cout<<"Image"  << " is destroyed." << std::endl;    }
